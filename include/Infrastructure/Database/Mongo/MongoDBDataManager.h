...
class MongoDBDataManager {
  ...
  public:
    ...
    void updateElement(const std::string& collectionName,
                       const std::string& docparameter,
                       const std::string& email,
                       const std::string& prevVal,
                       const bool updateValue);
    std::optional<bsoncxx::document::value> findOne(const std::string& collectionName,
  ...
  private:
    ...
    // bsoncxx::document::view_or_value& filter); std::string getUserOID(const std::string& collectionName,
    // std::optional<bsoncxx::document::view_or_value>& view);
    std::optional<bsoncxx::document::element> findElement(const std::string& collectionName,
    ...
    void updateDoc(const std::string& collectionName,
                   std::optional<bsoncxx::v_noabi::document::value> filterDoc,
