...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("64-windows/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-windows/lib:/C/d", f);
  fputs ("ev/Repos/InvokeInvoiceSystem/vcpkg_installed/vcpkg/pkgs/libiconv_x64-windows/C/", f);
  fputs ("dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-windows/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/vcpkg/pkgs/libiconv_", f);
  fputs ("x64-windows/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-windows/lib:$PA", f);
  fputs ("TH\"\n", f);
  fputs ("\n", f);
