...
const char * LIB_PATH_VALUE   = "C:\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\vcpkg\\blds\\libiconv\\x64-windows-rel\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\vcpkg\\blds\\libiconv\\x64-windows-rel\\lib\\.libs;C:\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\x64-windows\\lib;C:\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\x64-windows\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("64-windows-rel/lib/.libs:/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-w", f);
  fputs ("indows/lib:/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-windows/bin:$PA", f);
  fputs ("TH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/vcpkg/blds/libiconv/", f);
  fputs ("x64-windows-rel/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
