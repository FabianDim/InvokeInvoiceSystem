...
const char * LIB_PATH_VALUE   = "C:\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\C\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\x64-windows\\debug\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\C\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\x64-windows\\debug\\lib;C:\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\C\\dev\\Repos\\InvokeInvoiceSystem\\vcpkg_installed\\x64-windows\\debug\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/vcpkg/pkgs", f);
  fputs ("/libiconv_x64-windows/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-windo", f);
  fputs ("ws/debug/lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    PATH=/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/vcpkg/pkgs/libiconv_x", f);
  fputs ("64-windows/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-windows/debug/li", f);
  fputs ("b:/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/vcpkg/pkgs/libiconv_x64-wind", f);
  fputs ("ows/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-windows/debug/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/vcpkg/pkgs/libiconv_", f);
  fputs ("x64-windows/C/dev/Repos/InvokeInvoiceSystem/vcpkg_installed/x64-windows/debug/l", f);
  fputs ("ib:$PATH\"\n", f);
  fputs ("\n", f);
